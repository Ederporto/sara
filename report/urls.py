...
urlpatterns = [
    ...
    path("trimester", views.export_trimester_report, name="export_trimester_report"),
    path("trimester/per_area", views.export_trimester_report_by_by_area_responsible, name="export_trimester_report_by_area"),
