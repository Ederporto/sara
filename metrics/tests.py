...
class MetricFunctionsTests(TestCase):
    ...
    def test_get_metrics_and_aggregate_per_project_with_data_and_metric_unclear(self):
        ...
        self.assertEqual(list(aggregated_metrics[1]["project_metrics"].keys())[0], self.activity_1.id)
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity"], self.activity_1.text)
        self.assertEqual(list(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"].keys())[0], self.metric_2.id)
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["title"], self.metric_2.text)
        self.assertEqual(list(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"].keys())[0], "Other metric")
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"]["Other metric"]["goal"], "-")
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"]["Other metric"]["done"], "-")
    ...
    def test_get_metrics_and_aggregate_per_project_with_goal_but_none_done(self):
        ...
        self.assertEqual(list(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"].keys())[0], self.metric_2.id)
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["title"], self.metric_2.text)
        self.assertEqual(list(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"].keys())[0], "Wikipedia")
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"]["Wikipedia"]["goal"], 500)
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"]["Wikipedia"]["done"], 0)
    ...
    def test_get_metrics_and_aggregate_per_project_with_goal_and_some_done(self):
        ...
        self.assertEqual(list(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"].keys())[0], "Wikipedia")
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"]["Wikipedia"]["goal"], 500)
        self.assertEqual(aggregated_metrics[1]["project_metrics"][1]["activity_metrics"][2]["metrics"]["Wikipedia"]["done"], 200)
